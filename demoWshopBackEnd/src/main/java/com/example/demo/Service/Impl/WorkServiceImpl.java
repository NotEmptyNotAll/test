...
//                        }
                        try {
                            ...
                            if (worderId != null) {
                                ...
                                if (worderVo != null) {
                                    ...
                                    System.out.println("6 " + executors);
                                }
        ...
        try {
            ...
            if (clientOrdersRequest.getDetailId() != null) {
                // Фильтр по ID детали
                thLocateOptionsSet detailFilter = agent
                        .getDetailFilter(clientOrdersRequest
                                .getDetailId() == -1 ? null : clientOrdersRequest.getDetailId());
